...
import type { KudoProps } from "~/utils/types.server";
import { colorMap, backgroundColorMap, emojiMap } from '~/utils/constants';

export function Kudo({ profile, kudo}: KudoProps) {
    return (
        <div
          className={`flex ${backgroundColorMap[kudo.style?.backgroundColor || 'RED']} p-4 rounded-xl w-full gap-x-2 relative`}
        >
          <div>
