...
import type { UserPanelProps } from "~/utils/types.server";
...
export function UserPanel({ users }: UserPanelProps) {
  ...
  return (
    ...
    <div className="text-center bg-gray-300 h-20 flex items-center justify-center">
      <h2 className="text-xl text-blue-600 font-se,ibold">My team</h2>
    </div>
    ...
    <div className="text-center p-6 bg-gray-300">
      { /* POST: This will trigger the logout function at app/routes/logout.ts */}
